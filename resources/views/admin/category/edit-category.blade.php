        ...
        <form class="forms-sample" style="margin-top: 50px; margin-left: 20px;" method="post"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputUsername1" name="name" autocomplete="off"
                    placeholder="Name" required style="width: 600px;" value="{{$category->name}}">
            </div>
            <div class="mb-3">
                <label for="status" class="form-label required">Status</label>
                <select name="status" class="form-control" id="status" style="text-transform: lowercase; width: 600px;" required value="{{$category->status}}" >
